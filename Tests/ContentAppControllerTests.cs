...
namespace Tests
{
    public class ContentAppControllerTests
    {
        ...
        public void OverwritesAutoGeneratedFields()
        {
            ...
            new ContentAppController(contentTypeRepository, containerSpecificContentGetter, null, containerSpecificContentUpdater, null, null, null, null, null, null).SaveContent(body);
