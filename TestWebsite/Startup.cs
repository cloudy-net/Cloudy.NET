...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            using (var scope = app.ApplicationServices.CreateScope())
            {
                ...
                context.Pages.Add(new Page { Id = new Guid("e6fd53d8-c7de-4355-ae21-c588b2673c5c"), Name = "occaecat ullamco minim", RelatedPageId = new Guid("66e44063-a69f-41ac-82bf-220d70709801"), UrlSegment = "loremipsum", FrontpageBlock = new HeroBlock { Heading = "Lorem ipsum" } });
