...
function Text(props) {
    ...
    return html`
        <input ref=${ref} type=text class=cloudy-ui-form-input name=${fieldModel.descriptor.id} defaultValue=${initialValue} onInput=${changeEvent} readonly=${props.readonly}/>
    `;
}
